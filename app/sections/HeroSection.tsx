...
const HeroSection = () => {
	...
	useEffect(() => {
		const interval = setInterval(() => {
			const nextAnimation = (currentAnimation + 1) % animationSequences.length;
						...
						<motion.div
							...
							<motion.h1
								...
								<span className='gradient-text'>
									Smart, Fun, and Personalized
								</span>{' '}
								<span className='text-[#dbd957] font-normal'>
									Learning Support
								</span>
							</motion.h1>
							...
							<motion.p
								...
								ApprentieMalin uses AI to help primary and middle school
								students with homework, explain concepts, and make learning fun
								and all through WhatsApp.
							</motion.p>
